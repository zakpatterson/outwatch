...
object AsVDomModifier {
  ...
  implicit object JsArrayModifier extends AsVDomModifier[js.Array[VDomModifier]] {
    def asVDomModifier(value: js.Array[VDomModifier]): VDomModifier = CompositeModifier(value)
  }
  ...
  implicit object ArrayModifier extends AsVDomModifier[Array[VDomModifier]] {
    def asVDomModifier(value: Array[VDomModifier]): VDomModifier = CompositeModifier(value.toJSArray)
  }
  ...
  implicit object SeqModifier extends AsVDomModifier[Seq[VDomModifier]] {
    def asVDomModifier(value: Seq[VDomModifier]): VDomModifier = CompositeModifier(value.toJSArray)
  }
  ...
  implicit object OptionModifier extends AsVDomModifier[Option[VDomModifier]] {
    def asVDomModifier(value: Option[VDomModifier]): VDomModifier = value.getOrElse(VDomModifier.empty)
  }
  ...
  implicit object UndefinedModifier extends AsVDomModifier[js.UndefOr[VDomModifier]] {
    def asVDomModifier(value: js.UndefOr[VDomModifier]): VDomModifier = value.getOrElse(VDomModifier.empty)
  }
  ...
  implicit object EffectRender extends AsVDomModifier[IO[VDomModifier]] {
    def asVDomModifier(value: IO[VDomModifier]): VDomModifier = EffectModifier(value)
  }
